...
ERROR_CODE_CATALOG: dict[str, ErrorCodeSpec] = {
    ...
    "route_context_required": ErrorCodeSpec("route_context_required", "validation", False, "warn", "An explicit NCS job scope could not be resolved to one source-backed classification."),
    "needs_clarification": ErrorCodeSpec("needs_clarification", "validation", False, "warn", "The NCS scope is ambiguous and requires a bounded canonical choice."),
    "search_scope_containment_violation": ErrorCodeSpec("search_scope_containment_violation", "policy", False, "error", "NCS search results failed the effective classification-scope containment check."),
    ...
    "service_busy": ErrorCodeSpec("service_busy", "capacity", True, "warn", "Recommendation capacity is temporarily exhausted."),
