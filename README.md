...
| 날짜 | 내용 |
| --- | --- |
| 2026-09-18 | 임베딩 모델 4종 비교 — 한국어 소형 모델 채택(112MB, 질의 4ms), 콜드 1.5~1.7초 실측 |
| 2026-09-18 | 개발 평가 세트 30 → 90문항 확대(비HR 통제 45), 기준 Hit@3 `0.800`으로 재설정 |
| 2026-09-18 | 의미 재랭킹 서빙 타당성 실측 — 패키지 +156MB, 질의 4ms로 도입 가능 확인 |
| 2026-09-18 | 검색 실패 원인 규명 — 의미 기반 구제 재랭킹 실험에서 개발셋 Hit@3 `0.733 → 0.833`, 회귀 세트 무변동 |
