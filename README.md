...
| 검증 항목 | 현재 결과 |
| --- | --- |
| 40개 HR 실무 질의 Hit@1 | `0.475 → 0.825` (`+35.0%p`) |
| 40개 HR 실무 질의 Hit@3 | `0.500 → 0.875` (`+37.5%p`, 0.7 게이트 통과) |
| 40개 HR 실무 질의 MRR@10 | `0.5062 → 0.8550` |
...
| 전체 단위 테스트(로컬) | 총 `2,432개` 통과, `4개 skip` |
