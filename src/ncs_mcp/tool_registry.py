...
NCS_TOOL_CATEGORIES: dict[str, list[str]] = {
    ...
    "training_courses": ["ncs_training", "recommend_training_for_task", "recommend_training_transition"],
    "career_transition": ["recommend_task_transitions", "recommend_training_transition"],
